package classes.UIComponents 
{
	...
	public class ButtonTooltips extends Sprite
	{
		...
		private function BuildContentBlock():void
		{
			...
			var goodStat:Object = { fontFamily:"Lato", fontSize:14, color:"#7AC943", marginRight:1 };
			var badStat:Object = { fontFamily: "Lato", fontSize:14, color:"#CC3300", marginRight:1 };
			var indifferentStat:Object = { fontFamily: "Lato", fontSize: 14, color: "#3FA9F5", marginRight: 1 };
			
			var styleSheet:StyleSheet = new StyleSheet();
			styleSheet.setStyle(".words", defaultCSSTag);
			styleSheet.setStyle(".good", goodStat);
			styleSheet.setStyle(".bad", badStat);
			styleSheet.setStyle(".indifferent", indifferentStat);
		...
		private function BuildComparisonBlock():void
		{
			...
			var defaultCSSTag:Object = { fontFamily:"Lato", fontSize:14, color:"#FFFFFF", maginRight:0 };
			var goodStat:Object = { fontFamily:"Lato", fontSize:14, color:"#00CCFF", marginRight:0 };
			var badStat:Object = { fontFamily: "Lato", fontSize:14, color:"#CC3300", marginRight:0 };
			var noDiffStat:Object = { fontFamily: "Lato", fontSize:14, color:"#FFFFFF", marginRight:0 };
